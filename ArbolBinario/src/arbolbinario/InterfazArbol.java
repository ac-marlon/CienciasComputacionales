...
public class InterfazArbol extends javax.swing.JFrame {
    ...
    //Metodo crear nodo
    private Nodo crearNodo(String nombreNodo, int datoNodo, Nodo nodoPadre, String orientacion) {
    ...
    private void preOrden(Nodo raiz) {
        if (raiz != null) {
            resPre = resPre + raiz.getDato() + " - ";
            jTextField5.setText(resPre);
    ...
    private void inorden(Nodo raiz) {
        if (raiz != null) {
            ...
            resIn = resIn + raiz.getDato() + " - ";
            jTextField5.setText(resIn);
    ...
    private void posOrden(Nodo raiz) {
        if (raiz != null) {
            ...
            resPos = resPos + raiz.getDato() + " - ";
            jTextField5.setText(resPos);
            
        }
    }

    //Sumar todos los elementos
    private void sumarElementos(ArrayList<Nodo> listaNodos) {
        int sumaTotal = 0;
        for (int i = 0; i < listaNodos.size(); i++) {
            sumaTotal = sumaTotal + listaNodos.get(i).getDato();
        }
        jTextField5.setText(String.valueOf(sumaTotal));
    }

    //Sumar los elementos multiplos de tres
    private void sumarElementosMultTres(ArrayList<Nodo> listaNodos) {
        int sumaTotal = 0;
        for (int i = 0; i < listaNodos.size(); i++) {
    ...
    public void paint(Graphics g) {
        ...
        for (int i = 0; i < listaNodos.size(); i++) {
            if (listaNodos.get(i).getNombre().equals("raiz")) {
                g.drawRect(jPanel1.getWidth() / 2, jPanel1.getHeight() - 315, 20, 20);
                g.drawString(String.valueOf(listaNodos.get(i).getDato()), jPanel1.getWidth() / 2 + 8, jPanel1.getHeight() - 315 + 14);
            }
            if (listaNodos.get(i).getNodoDerecho() != null) {
                g.drawRect((jPanel1.getWidth() / 2) + (40 * (i + 1)), (jPanel1.getHeight() - 315) + (40 * (i + 1)), 20, 20);
                g.drawString(String.valueOf(listaNodos.get(i).getNodoDerecho().getDato()), (jPanel1.getWidth() / 2) + (40 * (i + 1)) + 8, (jPanel1.getHeight() - 315) + (40 * (i + 1)) + 14);
            }
            if (listaNodos.get(i).getNodoIzquierdo() != null) {
                g.drawRect((jPanel1.getWidth() / 2) - (40 * (i + 1)), (jPanel1.getHeight() - 315) + (40 * (i + 1)), 20, 20);
                g.drawString(String.valueOf(listaNodos.get(i).getNodoIzquierdo().getDato()), (jPanel1.getWidth() / 2) - (40 * (i + 1)) + 8, (jPanel1.getHeight() - 315) + (40 * (i + 1)) + 14);
            }
        }
        repaint();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nombre del nuevo nodo:");
        ...
        jLabel2.setText("Dato del nuevo nodo: ");
        ...
        jLabel3.setText("Nombre del nodo padre: ");
        ...
        jLabel4.setText("Orientacion del nuevo nodo (izq / der): ");
        ...
        jLabel5.setText("Arboles Binarios");

        jButton7.setText("Dibujar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        nombreNodo = jTextField1.getText();
        datoNodo = Integer.parseInt(jTextField2.getText());
        nombreNodoPadre = jTextField3.getText();
        for (int i = 0; i < listaNodos.size(); i++) {
            if (nombreNodoPadre.equals(listaNodos.get(i).getNombre())) {
                nodoPadre = listaNodos.get(i);
            }
        }
        orientacion = jTextField4.getText();
